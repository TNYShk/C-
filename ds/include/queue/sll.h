...
return 0 is list is NOT empty, otherwise 1*/
...
/* time complexity: O(n), space complexity O(1) 
search sll based on given param, return the containing node
*/
...
/* time complexity: O(n), space complexity O(1) 
changes requested nodes based on given request (function)
