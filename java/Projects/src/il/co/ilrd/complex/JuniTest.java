...
import static il.co.ilrd.complex.ComplexNumber.*;
...
class JuintTst{
    ...
    @Test
    void testEmptyNull(){
        ComplexNumber tanya = createReal(1);
        tanya.setImaginary(2);

        ComplexNumber maya = createReal(0);
        maya.setImaginary(-4);
        ComplexNumber adam = createReal(-2);
        maya.setImaginary(0);

        ComplexNumber twinky = createReal(2);
    ...
    void ParseTest() {
        ...
        ComplexNumber original = createReal(-26);
    ...
    void EqualsCompareToTest() {
        ComplexNumber twinky = createReal(2);
        twinky.setImaginary(4);
        ComplexNumber kika = createReal(2);
        kika.setImaginary(4);
    ...
    void ComplexOperationsTest(){
        ComplexNumber igal = createReal(1);
        igal.setImaginary(2);
        ComplexNumber twinky = createReal(2);
        twinky.setImaginary(4);
        ComplexNumber maya = createImaginary(-4);
        maya.setReal(0);

        double delta = 0.001;
        ComplexNumber div = igal.divideBy(twinky);
    ...
    @Test
    void testHashCode() {
        ComplexNumber z1 = createReal(6.5);
        z1.setImaginary(8);
        ComplexNumber z2 = createReal(6.5);
        z2.setImaginary(8);
        ...
        ComplexNumber z3 = createReal(7);
        z3.setImaginary(8);
        int n3 = z3.hashCode();
        assertTrue(n1 != n3);

        ComplexNumber z4 = createReal(0.8);
        z4.setImaginary(0);
        ComplexNumber z5 = createReal(0);
        z4.setImaginary(0.8);
        ...
        ComplexNumber z6 = createReal(0);
        z6.setImaginary(7.2);
        ComplexNumber z7 = createReal(0);
        z7.setImaginary(0.8);
        int n6 = z6.hashCode();
        int n7 = z7.hashCode();
        assertFalse(n6 == n7);
