...
/*   public static void trying(String word) throws IOException {
        URLConnection connection = new URL("https://api.dictionaryapi.dev/api/v2/entries/en/<endpoint>?param1=value1&param2=value2").openConnection();
